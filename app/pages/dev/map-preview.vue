...
<template>
  <main class="preview">
    ...
    <div :style="{ width: narrow ? '360px' : '100%', maxWidth: '100%', borderRadius: '24px' }">
      <PamanaMapLibreMap v-if="mounted" height="520px" :nodes="nodes" :vehicles="vehicles" :lines="lines" :user-location="user" :fit-key="fixtures ? 1 : 0"
